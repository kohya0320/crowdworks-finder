...
CATEGORIES = {
    ...
    "data_transform": {
        ...
        "category_ids": [249, 315],  # データ作成・入力, ECサイト運用ツール開発
        "core_keywords": ["csv", "スプレッドシート", "エクセル", "excel", "一括登録", "一括作成", "一括変換", "データ整形", "データ整理", "クレンジング", "自動化", "スクリプト", "python", "gas", "リスト作成", "リスト化", "api連携", "shopify", "システム連携", "ec連携"],
        "subcategories": {
            "CSV・Excel自動処理": {
